                                ...
                                <div class="cart_totals ">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr class="shipping">
                                                <th>Frete</th>
                                                <td>R$ 5,00 <small>prazo de 5 dia(s) </small></td>
                                            </tr>

                                            <tr class="order-total">
                                                <th>Total</th>
                                                <td><strong><span class="amount">R$<?php echo formatPrice($cart["vlsubtotal"]); ?></span></strong>"deixei esse codigo porque nao esta calculando o frete devido a restrição dos correios" </td> 
                                            </tr>
